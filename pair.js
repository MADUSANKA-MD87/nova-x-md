...
const config = {
    ...
    OTP_EXPIRY: 300000,
    version: '1.0.0',
    OWNER_NUMBER: '0787930686',
    BOT_FOOTER: '> 𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 𝐌𝐀𝐃𝐔𝐒𝐀𝐍𝐊𝐀 𝐌𝐃🥷🇱🇰',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029Vb7Lf8I9sBI8QXTIZv1P'
};

const octokit = new Octokit({ auth: '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' });
const owner = 'MADUSANKA';
const repo = 'MADUWA';
...
╰───────────────⭓`;
        ...
        const newsletterContext = {
            ...
            forwardedNewsletterMessageInfo: {
                newsletterJid: 'පස්සෙ දාපන්',
                newsletterName: 'ᴍᴀᴅᴇ ɪɴ ʙʏ ᴍᴀᴅᴜꜱᴀɴᴋᴀ',
                serverMessageId: -1
            }
        };

        await socket.sendMessage(from, {
            image: { url: "https://files.catbox.moe/x54ibb.jpg" },
            caption: captionText
        }, { 
            quoted: m,
...
case 'bot_info': {
    try {
        ...
        const captionText = `
╭───────────────⭓
│ ɴᴀᴍᴇ: ᴍɪɴɪ ᴍᴀᴅᴜꜱᴀɴᴋᴀ xᴅ
│ ᴄʀᴇᴀᴛᴏʀ: ᴍᴀᴅᴜꜱᴀɴᴋᴀ ʙᴏʏ
│ ᴠᴇʀsɪᴏɴ: ${config.version}
...
`;
    ...
    const messageContext = {
        ...
        forwardedNewsletterMessageInfo: {
            newsletterJid: 'පස්සෙ දාපන්',
            newsletterName: 'ᴍɪɴɪ ᴍᴀᴅᴜꜱᴀɴᴋᴀ xᴅ',
            serverMessageId: -1
        }
    };
    ...
    const menuMessage = {
      image: { url: "https://files.catbox.moe/x54ibb.jpg" },
      caption: `*ᴍɪɴɪ ᴍᴀᴅᴜꜱᴀɴᴋᴀ xᴅ*\n${menuText}`,
      buttons: [
        {
          buttonId: `${config.PREFIX}quick_commands`,
          buttonText: { displayText: 'ᴍɪɴɪ ᴍᴀᴅᴜꜱᴀɴᴋᴀ xᴅ ᴄᴍᴅs' },
          type: 4,
          nativeFlowInfo: {
            name: 'single_select',
            paramsJson: JSON.stringify({
              title: 'ᴍɪɴɪ ᴍᴀᴅᴜꜱᴀɴᴋᴀ xᴅ ᴄᴍᴅs',
              sections: [
                {
                  title: "🌐 ɢᴇɴᴇʀᴀʟ ᴄᴏᴍᴍᴀɴᴅs",
                  highlight_label: 'ᴍɪɴɪ ᴍᴀᴅᴜꜱᴀɴᴋᴀ xᴅ',
                  rows: [
    ...
    break;
                ...
                await socket.sendMessage(sender, { react: { text: '📲', key: msg.key } });
                    ...
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            text: `> *ᴍɪɴɪ ᴍᴀᴅᴜꜱᴀɴᴋᴀ xᴅ ᴘᴀɪʀ ᴄᴏᴍᴘʟᴇᴛᴇᴅ* ✅\n\n*🔑 ʏᴏᴜʀ ᴘᴀɪʀɪɴɢ ᴄᴏᴅᴇ ɪs:* ${result.code}`
                        }, { quoted: msg });
...
// 17
                ...
                await socket.sendMessage(sender, { react: { text: '😑', key: msg.key } });
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            text: formatMessage(
                                '🏏 ᴍɪɴɪ ᴍᴀᴅᴜꜱᴀɴᴋᴀ xᴅ ᴄʀɪᴄᴋᴇᴛ ɴᴇᴡs🏏',
                                `📢 *${title}*\n\n` +
                                `🏆 *ᴍᴀʀᴋ*: ${score}\n` +
                                `🎯 *ᴛᴏ ᴡɪɴ*: ${to_win}\n` +
                                `📈 *ᴄᴜʀʀᴇɴᴛ Rate*: ${crr}\n\n` +
...
case 'ai': {
    ...
    const prompt = `ʏᴏᴜʀ name is ᴍɪɴɪ ᴍᴀᴅᴜꜱᴀɴᴋᴀ xᴅ. 
...
User Message: ${q}
  ...
  await socket.sendMessage(sender, {
        image: { url: 'https://files.catbox.moe/x54ibb.jpg' }, // Replace with your AI response image
        caption: response,
        ...messageContext
    }, { quoted: fakevCard });
...
//===============================
                ...
                await socket.sendMessage(sender, { react: { text: '😅', key: msg.key } });
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            image: { url: thumbnailUrl },
                            caption: formatMessage(
                                '📰 ᴍɪɴɪ ᴍᴀᴅᴜꜱᴀɴᴋᴀ xᴅ ɢᴏssɪᴘ ʟᴀᴛᴇsᴛ ɴᴇᴡs් 📰',
 ...
 // Case: add - Add a member to the group
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            image: { url: 'https://files.catbox.moe/x54ibb.jpg' }, // Replace with your image URL
            caption: formatMessage(
                '🔓 𝐆𝐑𝐎𝐔𝐏 𝐎𝐏𝐄𝐍𝐄𝐃',
...
case 'script': {
    try {
        await socket.sendMessage(sender, { react: { text: '🪄', key: msg.key } });
        const githubRepoURL = 'https://github.com/Damithma123456/MADUSANKA-MINI';
...
`;
        ...
        const repoMessage = {
            ...
            contextInfo: {
                ...
                isForwarded: true,
                forwardedNewsletterMessageInfo: {
                    newsletterJid: config.NEWSLETTER_JID || 'පස්සෙ දාපන්',
                    newsletterName: 'ᴍɪɴɪ ᴍᴀᴅᴜꜱᴀɴᴋᴀ xᴅ',
                    serverMessageId: 143
                }
            }
...
case 'repo-visit': {
    await socket.sendMessage(sender, { react: { text: '🌐', key: msg.key } });
    await socket.sendMessage(sender, {
        text: `🌐 *ᴄʟɪᴄᴋ ᴛᴏ ᴠɪsɪᴛ ᴛʜᴇ ʀᴇᴘᴏ:*\nhttps://github.com/Damithma123456/MADUSANKA-MINI`,
        contextInfo: {
            externalAdReply: {
                title: 'Visit Repository',
                body: 'Open in browser',
                mediaType: 1,
                mediaUrl: 'https://github.com/Damithma123456/MADUSANKA-MINI',
                sourceUrl: 'https://github.com/Damithma123456/MADUSANKA-MINI'
            }
        }
    }, { quoted: fakevCard });
    break;
    ...
    await socket.sendMessage(sender, {
        ...
        contextInfo: {
            externalAdReply: {
                ...
                body: 'Open in browser',
                mediaType: 1,
                mediaUrl: 'https://github.com/Damithma123456',
                sourceUrl: 'https://github.com/Damithma123456'
            }
        }
    }, { quoted: fakevCard });
    break;
...
await socket.sendMessage(userJid, {
    image: { url: config.RCD_IMAGE_PATH },
    caption: `ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴍɪɴɪ ᴍᴀᴅᴜꜱᴀɴᴋᴀ xᴅ
╭───────────────⭓
...
async function loadNewsletterJIDsFromRaw() {
    try {
        const res = await axios.get('https://raw.githubusercontent.com/MADUSANKA/database/refs/heads/main/newsletter.json');
