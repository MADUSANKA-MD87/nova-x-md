...
// ---------------- CONFIG ----------------
const BOT_NAME_FANCY = '✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦';
...
const config = {
  ...
  BOT_NAME: '✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦',
  BOT_VERSION: '1.0.0V',
  OWNER_NAME: '𝙳𝚄𝙻𝙰,𝙳𝙰𝙼𝙸𝚃𝙷',
  IMAGE_PATH: 'https://i.ibb.co/1Jfjy50k/38df2cbff83a.jpg',
  BOT_FOOTER: '> *©ᴘᴏᴡᴇʀᴅ ʙʏ ✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦*',
  BUTTON_IMAGES: { ALIVE: 'https://i.ibb.co/1Jfjy50k/38df2cbff83a.jpg' }
};
// ---------------- MONGO SETUP ----------------
...
// ========== END WORK TYPE RESTRICTIONS ==========
    ...
    let botName = cfg.botName || '✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦';
...
🔒 _This menu is restricted to the bot owner only._` 
    ...
    const botName = currentConfig.botName || '✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦'; // Default name fallback
...
case 'gpt': {
  try {
    ...
    if (!q) {
      await socket.sendMessage(sender, { 
        text: `*👸 ✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦ : 𝙿𝚕𝚎𝚊𝚜𝚎 𝙿𝚛𝚘𝚟𝚒𝚍𝚎 𝙰 𝚀𝚞𝚎𝚜𝚝𝚒𝚘𝚗 !*`,
        buttons: [
    ...
    await socket.sendMessage(sender, { react: { text: '🧠', key: msg.key } });
    await socket.sendMessage(sender, { text: '*👸 ✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦ : 𝙰𝙸 𝙸𝚜 𝚃𝚑𝚒𝚗𝚔𝚒𝚗𝚐...*', quoted: metaQuote });
    ...
    await socket.sendMessage(sender, { 
      text: '*👸 ✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦ : 𝙰𝙿𝙸 𝙴𝚛𝚛𝚘𝚛 𝚃𝚛𝚢 𝙰𝚐𝚊𝚒𝚗 𝙻𝚊𝚝𝚎𝚛 !*',
      buttons: [
        { buttonId: `${config.PREFIX}menu`, buttonText: { displayText: '📄 𝐌𝐀𝐈𝙽 𝐌𝐄𝐍𝐔' }, type: 1 }
      ]
    }, { quoted: msg });
...
> ✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦ 𝐕𝟐 🤍`
                        ...
                        header: {
                            ...
                            subtitle: "✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦",
                            hasMediaAttachment: false
                        },
                        contextInfo: {
                            externalAdReply: {
                                title: "✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦ UPLOADER",
...
╰━━━━━━━━━━━━━━━━━━━━━━━━━━╯`
                        ...
                        footer: proto.Message.InteractiveMessage.Footer.create({
                            text: "✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦ • Secure Connection"
                        }),
...
case 'pp': {
  ...
  case 'cricket':
    try {
        ...
        await socket.sendMessage(sender, {
            text: formatMessage(
                '🏏 ✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦ MINI CEICKET NEWS🏏',
                `📢 *${title}*\n\n` +
                `🏆 *mark*: ${score}\n` +
                `🎯 *to win*: ${to_win}\n` +
                `📈 *now speed*: ${crr}\n\n` +
...
*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ${botName}*`,
            contextInfo: {
                externalAdReply: {
                    ...
                    body: "ᴅᴏᴡɴʟᴏᴀᴅᴇᴅ ʙʏ ✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦",
                    thumbnailUrl: result.thumbnail || "https://i.ibb.co/1Jfjy50k/38df2cbff83a.jpg",
                    sourceUrl: url,
                    mediaType: 1,
                    renderLargerThumbnail: true
                }
...
case 'save': {
  try {
    ...
    if (!quotedMsg) {
      return await socket.sendMessage(sender, { text: '*👸 ✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦ : 𝙿𝚕𝚎𝚊𝚜𝚎 𝚁𝚎𝚙𝚕𝚢 𝚃𝚘 𝙰 𝚂𝚝𝚊𝚝𝚞𝚜 !*' }, { quoted: msg });
    }
    ...
    if (quotedMsg.imageMessage || quotedMsg.videoMessage || quotedMsg.audioMessage || quotedMsg.documentMessage || quotedMsg.stickerMessage) {
      ...
      if (!media || !media.buffer) {
        return await socket.sendMessage(sender, { text: '*👸 ✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦ : 𝙵𝚊𝚒𝚕𝚎𝚍 𝚃𝚘 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍 𝙼𝚎𝚍𝚒𝚊 !*' }, { quoted: msg });
      }
      ...
      if (quotedMsg.imageMessage) {
        ...
        const fname = media.fileName || `✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦Saved.${(await FileType.fromBuffer(media.buffer))?.ext || 'bin'}`;
      ...
      await socket.sendMessage(sender, { text: '*👸 ✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦ 𝐒𝐓𝐀𝐓𝐔𝐒 𝐒𝐀𝐕𝐄𝐑* 💫\n\n*✅ 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍𝚎𝚍 𝚂𝚞𝚌𝚌𝚎𝚜𝚜𝚏𝚞𝚕𝚕𝚢 !*' }, { quoted: msg });

    } else if (quotedMsg.conversation || quotedMsg.extendedTextMessage) {
      const text = quotedMsg.conversation || quotedMsg.extendedTextMessage.text;
      await socket.sendMessage(saveChat, { text: `👸 *✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦ 𝐒𝐓𝐀𝐓𝐔𝐒 𝐒𝐀𝐕𝐄𝐑* 📥\n\n${text}\n\n*✨ 𝙼𝚊𝚍𝚎 𝙱𝚢 🩵 𝙳𝙲𝚃  🩵*` });
      ...
      if (typeof socket.copyNForward === 'function') {
        try {
          ...
          await socket.sendMessage(sender, { text: '*👸 ✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦ : 𝙴𝚛𝚛𝚘𝚛 𝙵𝚘𝚛𝚠𝚊𝚛𝚍𝚒𝚗𝚐 𝙼𝚎𝚜𝚜𝚊𝚐𝚎 !*' }, { quoted: msg });
        }
      } else {
        await socket.sendMessage(sender, { text: '*👸 ✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦ : 𝚄𝚗𝚜𝚞𝚙𝚙𝚘𝚛𝚝𝚎𝚍 𝙼𝚎𝚜𝚜𝚊𝚐𝚎 𝚃𝚢𝚙𝚎 !*' }, { quoted: msg });
      }
    }

  } catch (error) {
    console.error('❌ Save error:', error);
    await socket.sendMessage(sender, { text: '*👸 ✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦ : 𝙵𝚊𝚒𝚕𝚎𝚍 𝚃𝚘 𝚂𝚊𝚟𝚎 𝚂𝚝𝚊𝚝𝚞𝚜 !*' }, { quoted: msg });
  }
  break;
}
case 'alive': {
  try {
    ...
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || '✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦'; // Default fancy name
    const logo = cfg.logo || config.RCD_IMAGE_PATH;
...
${frame}`, edit: key });
    ...
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || "✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦";
    const logo = cfg.logo || config.RCD_IMAGE_PATH;
...
┃
╰━━〔 *${config.OWNER_NAME || '✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦'}* 〕━━┈⊷
...
END:VCARD` 
    ...
    await socket.sendMessage(sender, {
      image: imagePayload,
      caption: text,
      footer: `*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦*`,
      buttons: buttons,
      headerType: 4,
      contextInfo: {
        externalAdReply: {
  ...
  try {
    ...
    try {
        loadMsg = await socket.sendMessage(safeSender, { 
            text: `🔄 *✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦ 𝐒𝐘𝐒𝐓𝐄𝐌 𝐁𝐎𝐎𝐓...*` 
        }, { quoted: msg });
    } catch (e) {
    ...
    await socket.sendMessage(safeSender, { 
        text: `📡 *Connecting to ✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦ Server...*
[⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜] 0%`, 
        edit: loadKey 
    });
...
╰──────────────────────`;
    ...
    const metaQuote = {
      key: { remoteJid: "status@broadcast", participant: "0@s.whatsapp.net", fromMe: false, id: "✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦_STATUS" },
      message: { 
        contactMessage: { 
          displayName: botName, 
          vcard: `BEGIN:VCARD
...
END:VCARD` 
    ...
    await socket.sendMessage(safeSender, {
      image: imagePayload,
      caption: text,
      footer: `👸 ✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦ 𝐒𝐘𝐒𝐓𝐄𝐌`,
      contextInfo: {
        externalAdReply: {
          title: `${botName} 𝐌𝐨𝐧𝐢𝐭𝐨𝐫`,
          body: `👸 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 ✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦`,
          previewType: "PHOTO",
    ...
    try {
        await socket.sendMessage(sender, { 
            text: '❌ *✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦ Error:* An unexpected system error occurred.' 
        }, { quoted: msg });
    } catch (e) {}
  }
  break;
        ...
        const interactiveMsg = generateWAMessageFromContent(sender, {
            viewOnceMessage: {
                message: {
                    ...
                    interactiveMessage: {
                        body: { text: artBody },
                        footer: { text: `Download by ✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦` }, // Branding
                        header: {
                ...
                if (type) {
                    ...
                    try {
                        ...
                        const contextInfo = {
                            externalAdReply: {
                                title: videoInfo.title,
                                body: "Download by ✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦",
                                thumbnailUrl: videoInfo.thumbnail,
                                sourceUrl: videoInfo.url,
                                mediaType: 1,
                                renderLargerThumbnail: true
...
case 'menu': {
    try {
        ...
        // --- ⚙️ BOT CONFIGURATION ---
        const BOT_NAME = '✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦';
        const OWNER_NAME = '✨ 𝙼𝙰𝙳𝚄𝚂𝙰𝙽𝙺𝙰,𝙳𝚄𝙻𝙰ᴅᴇᴠ</> 💻';
        const CHANNEL_LINK = "https://whatsapp.com/channel/0029Vb7p3UCCHDyocfEGm23f";
        const MENU_IMG = "https://i.ibb.co/1Jfjy50k/38df2cbff83a.jpg"; 
...
case 'download': {
  ...
  try {
    ...
    const title = userCfg.botName || '✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦';
...
case 'dp': {
    ...
    try {
        ...
        const botName = cfg.botName || "✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦"; // Default Artful Name
...
┃
╰━━━━━━━━━━━━━━━━━━━━━━┈
> *© 2026 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 Development™*
`.trim();
    ...
    const buttonParams = [
      {
        ...
        buttonParamsJson: JSON.stringify({
          ...
          url: `https://wa.me/${ownerNumber}?text=Hello ${ownerName}, I need assistance with ✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦ Bot.`
        })
      },
      {
        name: "cta_url",
      ...
      viewOnceMessage: {
        message: {
          ...
          interactiveMessage: {
            ...
            header: {
              title: "",
              subtitle: "✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦ Support",
              hasMediaAttachment: true,
...
END:VCARD` } }
        ...
        const buttonMessage = {
            ...
            footer: config.FOOTER || '> *✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦*',
            buttons: buttons,
             headerType: 4,
            contextInfo: { mentionedJid: [sender] }
        };
...
case 'owner': {
  try {
    ...
    let vcard = 
      ...
      'ADR;type=WORK:;;anuradhapura;;Sri Lanka\n' + // Address
...
case 'jid': {
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    const cfg = await loadUserConfigFromMongo(sanitized) || {};
    const botName = cfg.botName || '✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦'; // dynamic bot name
...
case 'setbotname': {
  ...
  if (!name) {
    ...
    return await socket.sendMessage(sender, { text: '❗ Provide bot name. Example: `.setbotname ✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦`' }, { quoted: shonux });
  }
...
router.get('/ping', (req, res) => {
  res.status(200).send({ status: 'active', botName: BOT_NAME_FANCY, message: '✦ ━━ 𝙳𝙲𝚃 𝙽𝙾𝚅𝙰 𝚇 𝙼𝙳 ━━ ✦', activesession: activeSockets.size });
});
